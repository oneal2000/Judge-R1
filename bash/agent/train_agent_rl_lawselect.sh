...
# ============== LawSelect 任务配置 ==============
echo "[CONFIG] 任务: LawSelect (筛选相关法条)"
DATA_DIR="${ROOT}/data/agent_rl/law_select_train.jsonl"
REWARD_FUNC="law_select_reward"
OUT_DIR="${ROOT}/output/agent_rl_lawselect_3b_v3"
MAX_INPUT_LENGTH=5000
MAX_OUTPUT_LENGTH=1024
NUM_GENERATIONS=16      # 增加采样数量，更好的梯度估计
...
echo "=========================================="
echo "  Agent RL 训练 (GRPO) - LawSelect"
echo "=========================================="
echo "  任务: LawSelect (筛选相关法条)"
echo "  模型: ${BASE_MODEL}"
echo "  数据: ${DATA_DIR}"
...
# ============== 训练参数 ==============
# 关键改进 v3：
# - beta = 0.15，更强的 KL 惩罚，确保不偏离基座
# - num_generations = 12，更多采样
# - num_train_epochs = 3，更充分训练
# - temperature = 0.9，更多多样性
